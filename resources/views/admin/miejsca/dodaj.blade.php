                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('miejsca.store') }}">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-6">
                                    <input  value="{{$kolumna}}" min="0" name="nr_na_grid" id="nr_na_grid" type="number" max="30" class="form-control @error('nr_na_grid') is-invalid @enderror"  required autocomplete="nr_na_grid" autofocus>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-6">
                                    <input min="0" value="{{$rzad}}" name="rzad" id="rzad" type="number" max="15" class="form-control @error('rzad') is-invalid @enderror"  required autocomplete="rzad" autofocus>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-6">
                                    <select name="sala_id" id="sala_id" class="form-control @error('sala_id') is-invalid @enderror" required>
                                        <option value="{{$salaa}}">{{$salaa}}</option>
